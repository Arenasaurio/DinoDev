...
hist(data2$ent_resid, main = "Entidad residencia", xlab = "miColumna")
...
hist(data2$ent_ocurr, main = "Entidad ocurrencia", xlab = "miColumna")
...
hist(data2$sexo, main = "Sexo", xlab = "miColumna", xlim = c(0, 3))
...
hist(data2$edad_madn, main = "Edad madre", xlab = "miColumna")
...
hist(data2$edad_padn, main = "Edad padre", xlab = "miColumna")
...
hist(data2$ano_nac, main = "Ano nacimiento", xlab = "miColumna", breaks = 1000, xlim = c(2000, 2025))
...
hist(data2$mes_nac, main = "Mes nacimiento", xlab = "miColumna", breaks = 100, xlim = c(1,12))
...
hist(data2$escol_mad, main = "Escolaridad Madre", xlab = "miColumna")
...
hist(data2$escol_pad, main = "Escolaridad Padre", xlab = "miColumna")
